...
import pandas as pd
import numpy as np
from data_loader.data_loader_periodicmove import shenzhen_data_loader
...
# 3.训练模型
train_epochs = 2000
model_optim = optim.Adam(model.parameters(), lr=0.002, weight_decay=0.02)
        ...
        for j, (val_hist_traj_grid, val_userId, val_mask_pos, val_mask_curr_traj_grid, val_mask_value,
            ...
            if round(true_count / (fasle_count + true_count), 4) > max_val:
                ...
                torch.save(model.state_dict(),
                           'pars/periodicmove/periodicmove_shenzhen_recall@{}_{}'.format(recall,
