...
class MyModel(nn.Module):
    ...
    def forward(self, hist_traj_grid, dtw_border, mask_pos, mask_curr_traj_grid, historical_input_A, current_input_A,
        ...
        seq_hidden_history = hist_traj_grid + self.pe(hist_traj_grid)

        mask_curr_traj_grid = self.grid_embedding(mask_curr_traj_grid)
        seq_hidden_current = mask_curr_traj_grid + self.pe(mask_curr_traj_grid)
        ...
        seq_hidden_history = self.hist_self_attention(seq_hidden_history, seq_hidden_history, seq_hidden_history)
