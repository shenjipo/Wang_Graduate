...
class PeriodiceMove(nn.Module):
    ...
    def forward(self, hist_traj_grid, userId, mask_pos, mask_curr_traj_grid, historical_input_A, current_input_A,
        ...
        soft attention
        '''
        seq_hidden_history = self.soft_attention(seq_hidden_history, seq_hidden_current)
        ...
        # hybrid_embedding = self.curr_self_attention(hybrid_embedding, hybrid_embedding, hybrid_embedding)
